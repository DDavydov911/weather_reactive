...
public class WeatherControl {
    ...
    @GetMapping(value = "/cityGreatThen/{dergees}", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    public Flux<Weather> byDegrees(@PathVariable Integer dergees) {
        Flux<Weather> data = weathers.findByDegrees(dergees);
